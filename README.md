...
- **Cluster 0:** The three most highly expressed marker genes are APOD, DCN, and GSN. DCN is normally involved in collagen formation and is found in connective tissue, and GSN is an actin-binding protein that is often upregulated in and acts as a marker gene for fibroblasts. Thus, we can say with moderate to high confidence that cluster 0 represents **fibroblasts**.
...
- **Cluster 3:** the three most highly expressed genes are FABP4, which is involved in lipid metabolism and adipocytes; IFI27, a non cell-type specific marker; and CAV1, which is commonly found in adipocytes and endothelial cells. Thus, we can say with medium to high certainty that cluster 3 represents **adipocytes**.
- **Cluster 4:** FABP4 is also highly expressed in cluster 4, as is FABP5, which is also involved in lipid metabolism and is commonly found in immune cells, and CD74, which is highly expressed in antigen-presenting cells. Thus, we can say with medium confidence that cluster 4 represents **adipocytes** or **immune cells**. 
...
Based on the information above, we can tentativley conclude that our vastus lateralis muscle biopsies were composed of fibroblasts (cluster 0 and 9), pericytes or smooth muscle cells (cluster 1 and 5), endothelial cells (cluster 2 and 6), adipocytes (cluster 3 and 4), macrophages (cluster 7 and 10), NK or T cells (cluster 8), and lymphocytes (cluster 11), as depicted below:

<img src="images/annotated_umap.png" alt="Description" width="525" height="400">
...
After combining clusters with shared identity, we get the following breakdown: adipocytes (25.3%), fibroblasts (20.3%) , endothelial cells (18.4%), macrophages (14.0%), pericytes or smooth muscle cells (12.9%), NK or T cells (5.1%), and lymphocytes (3.9%). 

Notably, the percent contribution from adipocytes seems quite high for skeletal muscle tissue unless the sample includes a significant amount of adipose tissue (improper sample processing) or the individual has a higher-than-average body fat percentage. Additionally, the percentage contribution from fibroblasts is higher than expected. While the study does describe the steps for processing the skeletal muscle samples, they do not specifically mention the manual removal of adipose and connective tissue from the samples. Therefore, nonskeletal muscle cells can be present in the final cell suspension, explaining the high contribution of adipocytes and fibroblasts, which comprise a combined ~45% of the sample. 

Also of note is that macrophages make up a higher than expected percentage of the sample's cellular composition, which may be attributable to ongoing inflammation or repair in the tissue (as is common following an intense exercise stimulus). Meanwhile, the percent contribution from endothelial cells, pericytes or smooth muscle cells, NK or T cells, and lymphocytes are within expected ranges. 

To further validate our findings above, we'll need to compare them with other skeletal muscle single-cell studies to see if similar cell type proportions are reported. If the adipocyte and fibroblast proportions in our samples still seem unusually high, we might consider performing additional filtering on the data to remove a fraction of fibroblasts and adipocytes, then running the analysis again to see if the results better match other studies.  
